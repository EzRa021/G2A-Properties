        ...
        <footer className=" bg-blue text-white overflow-hidden ">
            <div className="lg:p-[60px] p-5">
                <div className="grid xl:grid-cols-3 grid-cols-2 gap-5 border-b-2 lg:pb-20 pb-2 border-[#818181]">
                    <div className="lg:w-[400px] w-full sm:text-[13px] text-[0.8rem] mr-7">
                    ...
                    <div className="sm:text-[13px] text-[0.8rem] mr-20  lg:w-[300px] w-full">
                    ...
                    <div className="xl:col-auto col-span-2 sm:text-[13px] text-[0.8rem] lg:w-[450px] w-full">
                        <p  className="font-bold sm:text-[15px] text-[0.8rem]">Subscribe</p>
                        ...
                        <p className="mt-5 sm:text-[12px] text-[0.8rem] underline sm:w-64 w-36 ">By subscribing you agree to with our Privacy Policy and provide consent to receive updates from our company.</p>

                    </div>
                </div>
                <div className='sm:text-[13px] text-[0.8rem] lg:mt-7 mt-2 block lg:flex justify-between items-center'>
                    <div>
                        <h1>
