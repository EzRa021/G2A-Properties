...
const HomeContent = () => {
    ...
    return (
        <div className="">
            <div className=" mx-[20px] sm:mx-[30px] xl:mx-[80px] sm:my-[120px] my-10 grid lg:grid-cols-2 grid-cols-1 gap-7 ">
                ...
                <div className="flex justify-center w-full items-center ">
                    <div className="lg:mt-[70px] sm:mt-[130px] mt-[30px]" >
                        ...
                        <p className="sm:text-[19.5px] text-[0.7rem] mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
                        <button className="bg-orange cursor-pointer text-white px-5 py-4 rounded-lg text-[15px] mt-5" type="button">Get Started Here</button>

                    </div>

                </div>
            </div>
            <div className="  xl:mx-[100px] sm:px-[40px] mx-[20px]  lg:flex justify-center block  items-center gap-10 ">
                    ...
                    <div className="" >
                        ...
                        <div className="lg:flex block  mt-5 lg:p-7 p-5 bg-blue text-white rounded-xl">
                            <div className="mt-3 lg:mt-0">
                                ...
                                <h1 className="sm:text-[20px] text-[1rem] mt-3 sm:font-medium font-normal">Vetted Properties</h1>
                                <p className="mt-3 sm:text-[1rem] text-[0.7rem]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.</p>
            ...
            <div className=" lg:m-[90px] m-[25px] ">
                <div className="flex justify-between items-center">
                    <h1 className="lg:text-[50px] sm:text-[50px] text-[30px] font-semibold">Properties for sale</h1>
                    <Link to="/Properties">
                        <button className="lg:block  hidden bg-[black] cursor-pointer text-white px-5 py-4 rounded-lg text-[15px] " type="button">Browse Properties</button>
                    </Link>

                </div>
                <div className="grid xl:flex justify-center items-center flex-wrap grid-cols-2 sm:grid-cols-2 gap-2  content-center justify-items-center ">
            ...
            <div className="flex justify-center items-center text-center">
                <div className="lg:w-[55%] w-[90%]">
                    ...
                    <p className="sm:text-[18px] text-[11px] lg:mt-10 mt-5">At G2A Properties, we are proud to collaborate with trusted business partners who share our commitment to excellence. Together, we create exceptional real estate solutions that redefine industry standards.</p>
                    <div className="flex justify-center items-center mt-10 ">
                        <img className="lg:w-[70%] w-[40%]" src="/Image6.png" alt="" srcset="" />
                    </div>

                </div>

            </div>
            <div className=" lg:m-[60px] my-[25px] mx-[5px] mt-[100px] ">
                ...
                <div className=" sm:mx-14 mx-2 grid lg:flex justify-center items-center flex-wrap sm:grid-cols-2 content-center gap-3 mt-16 grid-cols-1  ">
                    <div className=" shadow-xl lg:w-[25rem] sm:w-full w-full bg-white z-auto py-3">
                        <div className="" >
                    ...
                    <div className=" shadow-xl lg:w-[25rem] sm:w-full w-full bg-white z-auto p-3">
                        <div className="" >
                            <img src="/Image7.png" className="w-full h-52 sm:h-full" alt="" />
                        </div>
                        <div className="py-5">
            ...
            <div className="lg:m-[100px] m-[25px] mt-[150px]">
                <div className="">
                    <h1 className="lg:text-[45px] text-[33px] font-semibold">Customers testimonials</h1>
                    <p className="lg:text-[18px] text-center text-[12px] lg:mt-5 mt-3">Testimonials that Speak of G2A Properties' Exceptional Real Estate Experience.</p>
                </div>
                <div className=" mt-20">
