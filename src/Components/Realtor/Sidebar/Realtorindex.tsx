...
const RealtorSidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
        ...
        <nav className=" h-[100vh]  px-4 mt-1 lg:px-">
          ...
          <div>
            <div className="flex justify-center items-center gap-4 p-3 bg-[#f0f0f0] rounded-xl">
              ...
              <div>
                <h1 className='font-bold'>Jedidiah iohuuiui Olaleye</h1>
